...
<p align="center">
  <a href="https://www.amazon.com/Robot-Programmable-Interactive-Upgradable-Self-Balancing/dp/B0DR8RGVXN"><img src="assets/pu_voice.jpeg" alt="Robot PU singing into a microphone" width="480"></a><br>
  <i>Runs on any micro:bit V2 — sings loudest on <a href="https://www.amazon.com/Robot-Programmable-Interactive-Upgradable-Self-Balancing/dp/B0DR8RGVXN">Robot PU</a>.</i>
</p>
...
IMU — and with its built-in amplifier and speaker on pin 0, the SAM
voice comes out loud and clear instead of whisper-quiet through the
micro:bit's tiny on-board speaker.

Hear it live:

- [Robot PU introduces itself](https://youtube.com/shorts/lvVF9ypYzPM)
- [Robot PU sings Happy Birthday](https://youtube.com/shorts/sS_rEhxK5sg)

**[Get the Robot PU kit on Amazon →](https://www.amazon.com/Robot-Programmable-Interactive-Upgradable-Self-Balancing/dp/B0DR8RGVXN)** —
then add the [pxt-robotpu](https://github.com/robotgyms/pxt-robotpu)
motion extension so it can move while it sings. More at
[The Story of PU](https://www.youtube.com/@TheStoryofPu-yw8tr).

## Add to a MakeCode project

You need a micro:bit **V2** — and for the full voice, a
[Robot PU kit](https://www.amazon.com/Robot-Programmable-Interactive-Upgradable-Self-Balancing/dp/B0DR8RGVXN).
